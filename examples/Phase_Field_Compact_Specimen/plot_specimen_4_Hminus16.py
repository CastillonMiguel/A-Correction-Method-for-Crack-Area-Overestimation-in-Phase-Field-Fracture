...
Specimen 4 — curved crack (:math:`H = -1.6` mm)
------------------------------------------------

Compact tension specimen with internal voids offset by :math:`H = -1.6` mm, producing a
curvilinear crack path in the opposite direction to :ref:`ref_phase_field_compact_specimen_2_H16`.
This is the second curved-crack configuration from :footcite:t:`example_Wagner2018_phd_thesis`.
...
- Mesh: ``GmshGeoFiles/Compact_specimen/specimen_4_Hminus16.msh``
