...
Specimen 1 — straight crack (:math:`H = 0`)
--------------------------------------------

Compact tension specimen with no internal voids and a straight crack path (:math:`H = 0` mm).
This is the baseline configuration from :footcite:t:`example_Wagner2018_phd_thesis`.
...
- Mesh: ``GmshGeoFiles/Compact_specimen/specimen_1_H00.msh``
...
ax_1_gamma_Ofactor.set_ylabel(pcfg.correction_factor)
ax_1_gamma_Ofactor.set_xlim(left=-0.03, right=1.0)
ax_1_gamma_Ofactor.set_ylim(0.95, 1.8)
ax_1_gamma_Ofactor.legend()
...
ax_1_force_displacement.set_xlim(left=-0.03, right=1.0)
ax_1_force_displacement.set_ylim(bottom=-1, top=22.3)
