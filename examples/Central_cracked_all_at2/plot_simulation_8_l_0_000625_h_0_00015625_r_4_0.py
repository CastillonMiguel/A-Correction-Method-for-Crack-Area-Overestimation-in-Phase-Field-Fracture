...
Finest case of the :math:`l/h = 4.0` convergence group (Study 1, Group B).
See :ref:`ref_examples_phase_field_central_crack` for the problem description and parameter tables.

- Length scale: :math:`l = 0.000625` mm
- Mesh size: :math:`h = 0.00015625` mm  (:math:`l/h = 4.0`)
- Unstructured mesh generated with Gmsh
"""
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_cc_sim_8")
...
msh_file = os.path.join("../GmshGeoFiles/central_cracked/h_0_00015625.msh")  # Path to the mesh file
...
T_top = dolfinx.fem.Constant(msh, petsc4py.PETSc.ScalarType((0.0, 0.5/surface_aplication_force)))
