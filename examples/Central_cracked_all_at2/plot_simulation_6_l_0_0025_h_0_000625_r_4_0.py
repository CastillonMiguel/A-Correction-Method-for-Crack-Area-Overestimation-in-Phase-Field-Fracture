...
Second case of the :math:`l/h = 4.0` convergence group (Study 1, Group B).
...
- Mesh size: :math:`h = 0.000625` mm  (:math:`l/h = 4.0`)
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_cc_sim_6")
...
msh_file = os.path.join("../GmshGeoFiles/central_cracked/h_0_000625.msh")  # Path to the mesh file
