...
Part of Study 2: fixed length scale :math:`l = 0.0025` mm, varying :math:`l/h`.
...
- Mesh size: :math:`h = 0.000833` mm  (:math:`l/h = 3.0`)
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_cc_sim_9")
...
msh_file = os.path.join("../GmshGeoFiles/central_cracked/h_0_0008333333.msh")  # Path to the mesh file
