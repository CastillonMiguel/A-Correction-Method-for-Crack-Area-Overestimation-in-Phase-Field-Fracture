...
Third case of the :math:`l/h = 4.0` convergence group (Study 1, Group B).
See :ref:`ref_examples_phase_field_central_crack` for the problem description and parameter tables.

- Length scale: :math:`l = 0.00125` mm
- Mesh size: :math:`h = 0.0003125` mm  (:math:`l/h = 4.0`)
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_cc_sim_7")
...
msh_file = os.path.join("../GmshGeoFiles/central_cracked/h_0_0003125.msh")  # Path to the mesh file
