...
Coarsest case of the :math:`l/h = 4.0` convergence group (Study 1, Group B).
...
- Mesh size: :math:`h = 0.003125` mm  (:math:`l/h = 4.0`)
- Structured rectangular mesh (:math:`320 \times 960` elements)
"""
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_cc_sim_5")
