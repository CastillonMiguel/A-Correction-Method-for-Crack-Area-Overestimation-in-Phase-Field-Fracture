...
Coarsest case of the AT1 convergence group.
See :ref:`ref_examples_phase_field_central_crack_at1` for the problem description and parameter table.

- Length scale: :math:`l = 0.0125` mm
- Mesh size: :math:`h = 0.005` mm  (:math:`l/h = 2.5`)
- Structured rectangular mesh (:math:`200 \times 600` elements)
- Penalization parameter: :math:`\rho = 10^6`
"""
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_cc_sim_1")
