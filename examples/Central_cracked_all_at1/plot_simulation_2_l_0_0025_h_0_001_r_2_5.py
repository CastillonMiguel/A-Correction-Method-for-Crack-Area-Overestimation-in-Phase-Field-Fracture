...
Second case of the AT1 convergence group.
See :ref:`ref_examples_phase_field_central_crack_at1` for the problem description and parameter table.

- Length scale: :math:`l = 0.0025` mm
- Mesh size: :math:`h = 0.001` mm  (:math:`l/h = 2.5`)
- Unstructured mesh generated with Gmsh
- Penalization parameter: :math:`\rho = 10^8`
"""
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_cc_sim_2")
...
msh_file = os.path.join("../GmshGeoFiles/central_cracked/h_0_001.msh")  # Path to the mesh file
