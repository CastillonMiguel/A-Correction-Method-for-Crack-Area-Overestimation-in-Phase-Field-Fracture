...
//gmsh central_cracked_3d.geo  -3 -o central_cracked_3d.msh

h      = 0.02;  //mesh size
hcrack = 0.0025; //mesh size near crack
thickness = 0.05;
...
Physical Surface("left_top", 47) = {31};
Physical Surface("left_bottom", 48) = {43};
Physical Volume("specimen", 49) = {1};
